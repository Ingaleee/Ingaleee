<div align="center">
  <picture>
    <source media="(max-width: 600px)" srcset="./assets/professional-hero-mobile.svg">
    <img src="./assets/professional-hero.svg" alt="Egor Solovyev — Senior C#/.NET Backend Engineer" width="100%">
  </picture>
</div>

<p align="center">
  <a href="mailto:egor_spaik05@mail.ru">Email</a>
  &nbsp;·&nbsp;
  <a href="https://t.me/Inga1e">Telegram</a>
  &nbsp;·&nbsp;
  <a href="https://gitlab.com/Ingaleee">GitLab</a>
  &nbsp;·&nbsp;
  <a href="https://github.com/Ingaleee?tab=repositories">Public repositories</a>
</p>

<div align="center">
  <picture>
    <source media="(max-width: 600px)" srcset="./assets/professional-impact-mobile.svg">
    <img src="./assets/professional-impact.svg" alt="Engineering focus and production impact" width="100%">
  </picture>
</div>
